...
func translateInputDefinition(ctx context.Context, in *InputDefinition, ownerKind, ownerName string) (*model.RunnerInputDefinition, error) {
	...
	return &model.RunnerInputDefinition{
		Name:        in.Name,
		Type:        parsedType,
